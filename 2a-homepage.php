                    ...
                    <div class="large-6 cell">
                        <div class="tabs-content" data-tabs-content="example-tabs">
                            <div class="tabs-panel is-active" id="panel1">
                                <h6>We have over 20,000 pop-ups in the UK &amp; Ireland, and for London <span style="font-size: 10px !important;">(BETA)</span> we have a unique collection of audience data to help you find your perfect pop-up</h6>
                                <label>Location
